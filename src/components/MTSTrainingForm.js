	...
	handleSubmit(e) {
		...
		if (errorMessage !== "") {
			...
			form.append(
				...
				escape(this.state.apprenticeName).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				...
				escape(this.state.apprenticeEmail).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				...
				escape(this.state.trainerName).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				...
				escape(this.state.trainerEmail).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			form.append(
				...
				escape(this.state.churchOrMinistry).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				...
				escape(this.state.yearOfApprentiship).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				...
				escape(this.state.plannedAttendance).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			if (this.state.plannedAttendance === "other") {
				form.append(
					...
					escape(this.state.additionalAttendanceInfo).replace(
						/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
						""
					)
				);
			...
			form.append(
				...
				escape(this.state.ableToFinanciallyContribute).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
	...
	render() {
				...
				<section>
					<form onSubmit={this.handleSubmit}>
						...
						<input
							...
							value={this.state.apprenticeName}
						/>
						<br />
						<br />
						...
						<input
							...
							maxLength="128"
							onChange={this.handleChange.bind(this)}
							value={this.state.apprenticeEmail}
						/>
						<br />
						<br />
						...
						<label>
							<strong>Church / Ministry working at</strong>{" "}
						</label>
						{requiredField}
						<br />
						<input
							...
							maxLength="128"
							onChange={this.handleChange.bind(this)}
							value={this.state.churchOrMinistry}
						/>
						<br />
						<br />

						<p>
							<strong>Current year of apprenticeship</strong> {requiredField}
						</p>
						<select
							name="yearOfApprentiship"
							value={this.state.yearOfApprentiship}
							onChange={this.handleChange.bind(this)}
						>
						...
						<label>
							<strong>Apprentice plans to come to combined apprentice training</strong> {requiredField}
						</label>
						<br />
						<br />
						<label>
							<input
								...
								value="weekly"
								onChange={this.handleChange.bind(this)}
								checked={this.state.plannedAttendance === "weekly"}
							/>{" "}
							Weekly &nbsp;
						</label>
						<br />
						<label>
							<input
								...
								value="fortnightly"
								onChange={this.handleChange.bind(this)}
								checked={this.state.plannedAttendance === "fortnightly"}
							/>{" "}
							Fortnightly &nbsp;
						</label>
						<br />
						<label>
							<input
								...
								value="monthly"
								onChange={this.handleChange.bind(this)}
								checked={this.state.plannedAttendance === "monthly"}
							/>{" "}
							Monthly &nbsp;
						</label>
						<br />
						<label>
							<input
								...
								value="whenPossible"
								onChange={this.handleChange.bind(this)}
								checked={this.state.plannedAttendance === "whenPossible"}
							/>{" "}
							Whenever Possible &nbsp;
						</label>
						<br />
						<label>
							<input
								...
								value="other"
								onChange={this.handleChange.bind(this)}
								checked={this.state.plannedAttendance === "other"}
							/>{" "}
							Other... &nbsp;
						</label>
						<br />
						...
						{this.state.plannedAttendance === "other" ? (
							<>
								<TextArea
									className="form-control"
									name="additionalAttendanceInfo"
									rows="7"
									onChange={this.handleChange.bind(this)}
									value={this.state.additionalAttendanceInfo}
								/>
								<br />
							</>
						) : (
						...
						<label>
							<strong>I am able to financially contribute $195 towards combined apprentice training</strong>{" "}
							{requiredField}
						</label>
						<br />
						<br />
						<label>
							<input
								type="radio"
								name="ableToFinanciallyContribute"
								value="yes"
								onChange={this.handleChange.bind(this)}
								checked={this.state.ableToFinanciallyContribute === "yes"}
							/>{" "}
							Yes &nbsp;
						</label>
						<br />
						<label>
							<input
								...
								value="no"
								onChange={this.handleChange.bind(this)}
								checked={this.state.ableToFinanciallyContribute === "no"}
							/>{" "}
							No &nbsp;
						</label>
						<br />
		...
		if (this.state.formSubmitted) {
			formSubmitted = (
				<div>
					<p>
						If possible, we do ask the church or ministry that they apprentice is working for to financially contribute
						$195 towards this service that the Vision 100 Network is offering. This money will go towards the
						administration work that is involved in setting up the weekly training and keeping it running throughout the
						year. To pay this please direct debit $195 using the following details:
					</p>
					...
					<p>
						If you require an invoice for this, please let{" "}
						<a href="mailto:rachael@vision100.org">rachael@vision100.org</a> know and she can arrange this. <br />
						<br />
						If you are an MTS Apprentice and would like to join in with these, please email{" "}
