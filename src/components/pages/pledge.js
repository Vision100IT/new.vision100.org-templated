    ...
    <section>
      ...
      <ContentWrapper>
        ...
        {showForm ? <>
          ...
          <>
            <br /><br />
            <p>Thank you so much for your financial support of the Vision 100 Network! We really appreciate your generosity to us in this way and for helping this really valuable work to continue. </p>

            <p>Please use the information below to set up your pledge:</p>

            <p>Vision 100 Network Inc<br />
              BSB: 087007<br />
              Account number: 548757295<br /></p>

            {showPaypal ? <PaypalSupport sid={submissionId} pledgeAmount={pledgeAmount} /> : ''}

            <p>Thanks again for your support! If you have any questions please contact <a href="mailto:jess@vision100.org">jess@vision100.org</a>.</p>
