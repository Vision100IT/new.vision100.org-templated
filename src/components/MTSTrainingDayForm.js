						...
						{this.state.whoRegistering === "justme" || this.state.whoRegistering === "meandothers" ? (
							<>
								<fieldset>
									...
									<br />
									<label>
										<strong>Attended an MTS Training Day Before?</strong> {requiredField}
									</label>
									<br />
									<br />
									<label>
										<input
											...
											value="no"
											onChange={this.handleChange.bind(this)}
											checked={this.state.attendedBefore === "no"}
										/>{" "}
									...
									<label>
										<input
											...
											value="yes"
											onChange={this.handleChange.bind(this)}
											checked={this.state.attendedBefore === "yes"}
										/>{" "}
										I have been to an MTS Training Day before &nbsp;
									</label>
									<br />
									<br />
								</fieldset>
