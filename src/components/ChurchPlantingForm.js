...
const webformUUID = "90a7d16e-1d78-45b7-a55d-466b4176f27a"
...
class ChurchPlantingForm extends Component {
  ...
  handleSubmit(e) {
    ...
    if (errorMessage !== "") {
      ...
      if ((this.state.discountCode && this.state.discountCode.toLowerCase() === "v100cost") || (this.state.discountCode && this.state.discountCode.toLowerCase() === "v100 cost")) {
  ...
  render() {
    ...
    if (this.state.formSubmitted) {
      formSubmitted = (<div>
        {this.state.submissionID && this.state.paymentMethod === "paypal" ? <GenericPaypal sid={this.state.submissionID} totalCost={this.state.totalAmount} eventName="CPC" /> :
          <>
            <p>
              Thank you for your registering for the Tasmanian Church Planting Conference 2021.
