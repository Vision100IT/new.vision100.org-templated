	...
	handleSubmit(e) {
		...
		if (errorMessage !== "") {
			...
			form.append(
				...
				escape(this.state.fullName).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			form.append(
				"submission[data][9][values][0]",
				escape(this.state.person1Name).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				"submission[data][10][values][0]",
				escape(this.state.person1Email).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				"submission[data][11][values][0]",
				escape(this.state.person1Church).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			form.append(
				"submission[data][13][values][0]",
				escape(this.state.person2Name).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				...
				escape(this.state.person2Email).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				...
				escape(this.state.person2Church).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			form.append(
				...
				escape(this.state.person3Name).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				...
				escape(this.state.person3Email).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				"submission[data][19][values][0]",
				escape(this.state.person3Church).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			form.append(
				...
				escape(this.state.person4Name).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				...
				escape(this.state.person4Email).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				"submission[data][23][values][0]",
				escape(this.state.person4Church).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			form.append(
				...
				escape(this.state.person5Name).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				"submission[data][26][values][0]",
				escape(this.state.person5Email).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			form.append(
				"submission[data][27][values][0]",
				escape(this.state.person5Church).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			//dietaryreqs
			form.append(
				"submission[data][28][values][0]",
				escape(this.state.dietaryRequirements).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			form.append(
				...
				escape(this.state.discountCode).replace(
					/([\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2694-\u2697]|\uD83E[\uDD10-\uDD5D])/g,
					""
				)
			);
			...
			registrationForm = (
				<section>
					<form onSubmit={this.handleSubmit}>
						...
						<label>
							<strong>Who are you registering?</strong>
						</label>
						<br />
						<label>
							<input
								...
								value="justme"
								onChange={this.handleChange.bind(this)}
								checked={this.state.whoRegistering === "justme"}
							/>{" "}
							Just Me &nbsp;
						</label>
						<br />
						<label>
							<input
								...
								value="meandothers"
								onChange={this.handleChange.bind(this)}
								checked={this.state.whoRegistering === "meandothers"}
							/>{" "}
							Me and some others &nbsp;
						</label>
						<br />
						<label>
							<input
								...
								value="onlyothers"
								onChange={this.handleChange.bind(this)}
								checked={this.state.whoRegistering === "onlyothers"}
							/>{" "}
							Only Others &nbsp;
						</label>
						<br />
						<br />
						{this.state.whoRegistering !== "justme" ? (
							<>
								<p>
									<strong>How Many People (not including yourself) are you Registering?</strong>
								</p>
								<select
									name="otherRegistrations"
									value={this.state.otherRegistrations}
									onChange={this.handleChange.bind(this)}
								>
						...
						{this.state.whoRegistering !== "justme" && this.state.otherRegistrations > 0 ? (
							<>
								<fieldset>
									...
									<input
										...
										maxLength="128"
										onChange={this.handleChange.bind(this)}
										value={this.state.person1Church}
									/>
									<br />
									<br />
								</fieldset>
							...
							<>
								<fieldset>
									...
									<input
										...
										maxLength="128"
										onChange={this.handleChange.bind(this)}
										value={this.state.person2Church}
									/>
									<br />
									<br />
								</fieldset>
							...
							<>
								<fieldset>
									...
									<input
										...
										maxLength="128"
										onChange={this.handleChange.bind(this)}
										value={this.state.person3Church}
									/>
									<br />
									<br />
								</fieldset>
							...
							<>
								<fieldset>
									...
									<input
										...
										maxLength="128"
										onChange={this.handleChange.bind(this)}
										value={this.state.person4Church}
									/>
									<br />
									<br />
								</fieldset>
							...
							<>
								<fieldset>
									...
									<input
										...
										maxLength="128"
										onChange={this.handleChange.bind(this)}
										value={this.state.person5Church}
									/>
									<br />
									<br />
								</fieldset>
						...
						<br />
						<label>
							<strong>Please specify any dietary requirements here</strong>
						</label>
						<br />
						...
						/>
						<span style={{ fontSize: "14px" }}>Please write 'None' if you do not have any.</span>
						<br />
						<br />
						...
						/>
						<br />
						<span style={{ fontSize: "14px" }}>Enter a discount code here if you have one.</span>
						<br />
						<br />
						...
						<label>
							<input
								...
								onChange={this.handleChange.bind(this)}
							/>
							&nbsp;I would like to pledge to make an extra donation towards raising up leaders and church planting in
							Tasmania (recommended amount $25)
						</label>
						<br />
						<br />
						...
						<br />
						<p>
							<strong>Monthly Bulletin</strong>
						</p>
						<label>
							<input
								type="checkbox"
								...
								onChange={this.handleChange.bind(this)}
							/>
							&nbsp;I am happy to be added to the Vision 100 Network monthly email bulletin to keep in touch with what
						...
						<p>
							<em>
								Your privacy is important to us. Your information will be kept secure and used only for the purposes of
								the ministry of the Vision 100 Network. For our privacy policy, contact info@vision100.org
							</em>
						</p>
			...
			formSubmitted = (
				<div>
					{this.state.submissionID && this.state.paymentMethod === "paypal" ? (
						<GenericPaypal sid={this.state.submissionID} totalCost={this.state.totalAmount} eventName="CPC" />
					) : (
						<>
							<p>
								Thank you for your registering for the {tcpcEventName}. You will receive more information about the
							...
							<p>
								...
								<br />
								<br />
								Please deposit the full amount of ${this.state.totalAmount} into the following bank account:
								<br />
								<br />
								Account Name: Vision 100 Network
								<br />
								BSB: 087 007
								<br />
								Account No: 548757295
								<br />
								Reference: MTS {this.state.submissionID}
								<br />
							</p>
							<p>
								...
								<br />
								<br />
								Please make your cheque payable to 'The Vision 100 Network'
								<br />
								Post to: The Treasurer, Vision 100 Network
								<br />
								PO Box 5006, UTAS LPO, Sandy Bay TAS 7005
								<br />
								<br />
								Having difficulty with payment?
								<br />
								<br />
								Email <a href="mailto:eventmanager@vision100.org">eventmanager@vision100.org</a> with any questions you
								may have.
							</p>
						</>
					)}
...
export default ChurchPlantingForm;
