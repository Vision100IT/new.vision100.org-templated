...
class Paypal extends Component {
	constructor(props) {
		...
		this.state = {
			...
			eventConfirmationMessage: this.props.eventConfirmationMessage
		};
	}
	...
	render() {
		return (
			<section className="container padding-bottom-15">
				{this.state.eventConfirmationMessage ? (
					<p>{this.state.eventConfirmationMessage}</p>
				) : (
				...
				<p>
					{" "}
					<strong>In order to complete your payment please click the button below</strong> and you will be redirected to
					the Paypal site to make your payment using your Paypal account or credit card.
				</p>
				<p>
					If you encounter any problems or have any questions about the event please contact{" "}
					<a href="mailto:eventmanager@vision100.org">eventmanager@vision100.org</a>.
				</p>
